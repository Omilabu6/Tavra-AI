...
const Footer = () => {
  return (
    <div className={styles.footer}>
        ...
        <div >
          ...
          <h2 className='text-2xl my-6 w-[55%]'>Start your journey with Tavra AI today. Because the future of learning isn’t about watching it’s about doing, asking, and growing with a mentor who never stops believing in your potential.</h2>
            <Magnet padding={50} disabled={false} magnetStrength={3}>
              <div className='border-black border-2 px-10 py-10 flex justify-center items-center w-100 rounded-full text-2xl  cursor-pointer'>
                <Magnet padding={50} disabled={false}  magnetStrength={3}>
      ...
      <div className='text-xl flex gap-10  justify-between items-center px-40 -translate-y-10 '>
